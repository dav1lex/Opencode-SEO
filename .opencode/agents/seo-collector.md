...
1. Call `seo-fetch-http` with the URL. Save the result to `.playwright-mcp/site-pages/{page-index}/page-http.json`. This captures status, response headers, and the redirect chain, none of which the browser can show you.
